        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="breadcrumbs-title">Berita Vokasi</h2>
                    <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <span itemprop="name" style="color: #1977cc">Berita</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 entries">
                        @foreach ($events as $item)
                            <article class="entry d-flex"
                                style="border: 1px solid #ccc; padding: 20px; margin-bottom: 20px;">

                                <div class="entry-date"
                                    style="flex: 0 0 120px; text-align: center; border-right: 1px solid #ccc; padding-right: 20px;">
                                    <span class="date"
                                        style=" color:black; font-weight: bold; padding: 5px 10px; border-radius: 5px;">{{ date('d M Y', strtotime($item->tanggal)) }}</span>
                                </div>

                                <div class="entry-body" style="flex: 1; padding-left: 20px;">
                                    <h2 class="entry-title" style="margin-bottom: 10px;"
                                        style="color: #1977cc; text-decoration: none;">{{ $item->nama }}
                                    </h2>
